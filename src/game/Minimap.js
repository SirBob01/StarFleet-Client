  ...
  render (display, entities) {
    ...
    for (const entity of entities) {
      if (entity.class === 'Ship') {
        ...
        display.draw_circle(
          this.topleft.add(new dynamo.Vec2D(entity.center.x * this.o.x, entity.center.y * this.o.y)),
